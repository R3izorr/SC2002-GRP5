...
public class ApplicantDashBoard extends SimpleMenu{
    ...
    public ApplicantDashBoard(Applicant applicant, ProjectController projectController, ApplicationController applicationController,
        ...
        addOption(new UserOption("4", "Withdraw your Application", input -> new WithdrawApplicationService(applicationController).run()));
        addOption(new UserOption("5", "Request Flat Booking", input -> new RequestFlatBookingService(applicationController).run()));
