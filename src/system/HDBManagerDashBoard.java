...
public class HDBManagerDashBoard extends SimpleMenu {
    ...
    public HDBManagerDashBoard(HDBManager manager, UserController userController,
        ...
        addOption(new UserOption("4", "View All Projects", input -> new ViewAllProjectsService(projectRepository.getProjects()).run()));
        ...
        addOption(new UserOption("9", "View Assigned Projects", input -> new ViewAssignedProjectsService(manager, filterSettings).run()));
